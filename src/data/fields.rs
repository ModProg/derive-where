...
impl<'a> Fields<'a> {
	...
	pub fn from_named(path: Path, fields: &'a FieldsNamed) -> Result<Self> {
	...
	pub fn from_unnamed(path: Path, fields: &'a FieldsUnnamed) -> Result<Self> {
